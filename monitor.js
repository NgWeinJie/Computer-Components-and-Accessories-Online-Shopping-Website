...
function openSingleItem(itemNumber) {
    var modal = document.getElementById("item" + itemNumber);
    modal.style.display = "block";
}

function closeSingleItem(itemNumber) {
    var modal = document.getElementById("item" + itemNumber);
...
function retrieveData() {
    ...
    snapshot.forEach(function (childSnapshot) {
        ...
        // Check if the code starts with "m"
    ...
    sortedProducts.forEach(function (sortedProduct) {
        ...
        infoCell.style.width = "50%";
                ...
                image.alt = code + "_m1.png";
                image.classList.add("monitorImg1");
                ...
                descriptionLabel.classList.add("m4");
