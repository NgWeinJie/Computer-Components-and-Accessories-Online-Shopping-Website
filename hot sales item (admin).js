...
function retrieveData() {
    ...
    snapshot.forEach(function (childSnapshot) {
        ...
        // Check if the code starts with specific item
        if (code.startsWith("m8") || code.startsWith("d2") || code.startsWith("l5") || code.startsWith("a2")) {
            sortedProducts.push({
                code: code,
                product: product
            });
    ...
    sortedProducts.forEach(function (sortedProduct) {
        ...
        infoCell.style.width = "50%";
                ...
                image.classList.add("productsImg1");
